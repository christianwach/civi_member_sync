...
<table cellspacing="0" class="wp-list-table widefat fixed users">
 ...
 <tr>   
  <td><?php  echo civi_member_sync_get_names($value->civi_mem_type, $MembershipType);  ?>
  <br />
  ...
  <td><?php echo civi_member_sync_get_names($value->current_rule, $MembershipStatus); ?></td>
  <td><?php echo civi_member_sync_get_names($value->expiry_rule, $MembershipStatus);?></td>
